	...
	public MovieDaoCollectionImpl() {
		...
		if (movieList == null) {
			...
			try {
				...
				movieList
						.add(new Movie(3, "Pizza", 21874639444l, true, DateUtil
								.convertToDate("07/02/2017"), "Romance", false));

				movieList.add(new Movie(4, "French Fries", 1671713208l, false,
						DateUtil.convertToDate("09/02/2017"), "ScienceFiction",
						true));

				movieList.add(new Movie(5, "Chocolate Brownie", 2750760348l,
